    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.changeMenu:
                ...
                window.setItems(opciones, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (opciones[item].equals("Piano Tradicional")) {
                            Intent pianoTradicional = new Intent(AcercaDe.this, Piano_tradicional.class);
                            startActivity(pianoTradicional);
                        } else if (opciones[item].equals("Piano Infantil de la Selva")) {
                            Intent pianoJungle = new Intent(AcercaDe.this, Piano_infantil_selva.class);
                            startActivity(pianoJungle);

                        } else if (opciones[item].equals("Piano de Instrumentos musicales")) {
                            Intent pianoMusic = new Intent(AcercaDe.this, piano_Instrumentos.class);
                ...
                break;
            case R.id.about:
                Intent about = new Intent(AcercaDe.this,AcercaDe.class);
                startActivity(about);
                break;
            case R.id.exit:
                CerrarAplicacion();
